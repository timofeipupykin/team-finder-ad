...
## 5. Демо-данные для ревью

Чтобы быстро выполнить пункт чек-листа про наличие нескольких пользователей и проектов:
...
Команда создаст 3 тестовых аккаунта и минимум по 1 проекту на каждого пользователя.
